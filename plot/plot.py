...
def wrapperkeyPressHandler(fig,ax, run): 
    def _keyPressHandler(event):
        if event.key in ['n', 'N', 'u', 'U','m','M','o','O','g','G']: 
            ...
            tsp_graph = get_tsp_graph(run.points, mode='tour')
            n_common_edges = num_common_edges(tsp_graph, geometric_graph)
            print("------------------------------------------------------------------------------")
            print("Number of edges in " + algo_str + " graph                                :", len(geometric_graph.edges))
            print("\nNumber of edges in " + algo_str + " graph which are also in Concorde TSP :", n_common_edges)
